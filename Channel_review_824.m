...
%%
h_matrix_cut(:,[100,1520,1846,2238]) = abs(result_matrix(:,[100,1520,1846,2238]));
%%
...
filename = sprintf('824_%g_%g.png', eq_fb_taps,rls_forget); % 文件名
fig_path = fullfile(save_folder, sprintf('824_%g_%g.fig', eq_fb_taps,rls_forget));
saveas(gcf, fig_path, 'fig');
png_path = fullfile(save_folder, sprintf('824_%g_%g', eq_fb_taps,rls_forget));
saveas(gcf, png_path, 'png');
mat_path = fullfile(save_folder, sprintf('824_%g_%g.mat', eq_fb_taps,rls_forget));
