...
file_name_rev='D:\A_Matlab_program\A_Matlab_program\时变信道估计代码\接收单道片段-0528\19-924.8m\924.8_0019_0366_367_32K_240528_000010_0s_01.wav';    %接收信号
...
% 截出m序列
sig_bd_m = sig_bd_sync(1001750:1164320);
sig_rev_m = sig_rev_sync(1001750-1782+1398:1164320-1782+1398);
...
for window_duration = 1:max_window_duration
    ...
    % save_folder = '..\五月份实测数据\图像\924'; % 修改为您的目标文件夹
...
% yline(0.5, '--k', '0.5');
% yline(0.9, '--k', '0.9');
% save('924time_cor.mat', 'tau_axis_slow','rho_tau');
%
%
% % 相干带宽
% targetf = 0;
...
% % title('平均频率自相关函数');
% grid on;
% save('924band_cor.mat', 'freqLagAxis','rho_f');
%
% %% === 多普勒功率谱与扩展 ===
